...
rngSeed = randi(1000000);  %For Orguner: Seed 537646, Nh = 15, d=1, alpha = 20, beta = 0.1, Nr = 5, Runnalls vs alphaRed
                           %Other seed: Seed 26205 Nh = 15 d=1 alpha=35
...
exp1 = Experiment('',           {struct('rho',0.7),struct('k',2)},...
                  'IH2MRA',        struct('Nr',Nr,'alpha',0.4,'maxiter',100,'tol',1e-12),...
                  'CTDRef',           {struct('costMeas','H2ij'),struct('NOptSteps',69)},...
                  test,          struct('Nh',Nh,'alpha',alpha','beta',beta,'d',d,'rngSeed',rngSeed));              

              
exp2 = Experiment('',           {},...
                  'IBDMRA',       struct('Nr',Nr),... 
                  'CTDRef',           {struct('costMeas','BDij')},...
                  test,         struct('Nh',Nh,'alpha',alpha,'beta',beta,'d',d,'rngSeed',rngSeed));

exp3 = Experiment('',           {},...
                  'Runnalls',        struct('Nr',Nr,'maxiter',100,'tol',1e-12),...
                  'CTDRef',  {struct('costMeas','KLDij'),struct()},...
                  test,         struct('Nh',Nh,'alpha',alpha','beta',beta,'d',1,'rngSeed',rngSeed));
              
exp4 = Experiment('',           {},...
                  'ISKLDMRA',       struct('Nr',Nr,'maxiter',100,'tol',1e-12),...
                  'CTDRef',  {struct('costMeas','SKLDij')},...
                  test,         struct('Nh',Nh,'alpha',alpha','beta',beta,'d',1,'rngSeed',rngSeed));
              
exp5 = Experiment('',           {},...
                  'ICSDMRA',       struct('Nr',Nr,'costMeas','CSDij'),...
                  'CTDRef',  {struct('costMeas','CSDij'),struct()},...
                  test,         struct('Nh',Nh,'alpha',alpha','beta',beta,'d',d,'rngSeed',rngSeed));
              
          

experiments = [exp1;exp4;exp2;exp3;exp5];
