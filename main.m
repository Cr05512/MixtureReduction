...
exp1 = Experiment('',           {struct('rho',0.7),struct('k',2)},...
                  ...
                  '',           {struct('lambda',0.0,'costMeas','KLDij'),struct('NOptSteps',69)},...
                  test,          struct('Nh',Nh,'alpha',alpha','beta',beta,'d',d,'rngSeed',rngSeed));              

              
exp2 = Experiment('',           {},...
                  'alpha1Reduction',       struct('Nr',Nr,'alpha',0.7,'maxiter',100,'tol',1e-12),... 
                  '',           {struct('lambda',0.0,'costMeas','alpha1Dij','varargin',struct('alpha',0.1))},...
                  test,         struct('Nh',Nh,'alpha',alpha,'beta',beta,'d',d,'rngSeed',rngSeed));

exp3 = Experiment('',           {},...
                  'alpha2Reduction',        struct('Nr',Nr,'alpha',0.7,'maxiter',100),...
