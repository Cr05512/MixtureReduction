...
exp1 = Experiment('',           {struct('rho',0.7),struct('k',2)},...
                  ...
                  '',           {struct('lambda',1.0,'costMeas','MKLDij'),struct()},...
                  test,          struct('Nh',Nh,'alpha',alpha','beta',beta,'d',d,'rngSeed',rngSeed));              

              
exp2 = Experiment('',           {},...
                  'testAlgo',       struct('Nr',Nr,'costMeas','BDij'),...
                  '',           {struct()},...
                  test,         struct('Nh',Nh,'alpha',alpha,'beta',beta,'d',d,'rngSeed',rngSeed));

exp3 = Experiment('',           {},...
                  'BDMRA',       struct('Nr',Nr,'costMeas','TSLij'),...
...
%%
close all
globalMeas = {struct('globMeas','BD12','nPoints',2000),...
              struct('globMeas','KLD12','nPoints',2000),...
              struct('globMeas','CTD','costMeas','KLDij'),...
