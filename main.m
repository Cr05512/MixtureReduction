...
exp2 = Experiment('',           {},...
                  'Runnalls',       struct('Nr',Nr),...
                  'ISEOptUncMBI+weightISEOpt',           {struct('NOptSteps',100),struct()},...
                  test,         struct('Nh',Nh,'alpha',alpha','beta',beta,'d',d,'rngSeed',rngSeed));

exp3 = Experiment('',           {},...
                  'Runnalls',       struct('Nr',Nr),...
                  'ISEOpt+weightISEOpt',  {struct('NOptSteps',100,'sk',0.005),struct()},...
                  test,         struct('Nh',Nh,'alpha',alpha','beta',beta,'d',d,'rngSeed',rngSeed));
              
exp4 = Experiment('',           {},...
                  'BF',       struct('Nr',Nr),...
                  'ISEOpt',  {struct('sk',0.0005,'NOptSteps',100,'accThresh',1e-08)},...
                  test,         struct('Nh',Nh,'alpha',alpha','beta',beta,'d',d,'rngSeed',rngSeed));
