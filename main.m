...
exp1 = Experiment('',           {struct('rho',0.7),struct('k',2)},...
                  'IH2MRA',        struct('Nr',Nr,'maxiter',500,'tol',1e-9),...
                  '',           {struct('costMeas','H2ij'),struct('NOptSteps',69)},...
                  test,          struct('Nh',Nh,'gamma',gamma','beta',beta,'d',d,'rngSeed',rngSeed));              

              
exp2 = Experiment('',           {},...
                  'ISKLDMRA',       struct('Nr',Nr,'alpha',0.5,'maxiter',500,'tol',1e-12),... 
                  '',           {struct('costMeas','CSDij','maxiter',100)},...
                  test,         struct('Nh',Nh,'gamma',gamma,'beta',beta,'d',d,'rngSeed',rngSeed));

exp3 = Experiment('',           {},...
                  'IFKLDMRA',        struct('Nr',Nr,'maxiter',100,'tol',1e-9),...
                  '',  {struct('costMeas','W2ij'),struct()},...
                  test,         struct('Nh',Nh,'gamma',gamma','beta',beta,'d',d,'rngSeed',rngSeed));
              
exp4 = Experiment('',           {},...
                  'IFKLDMRA',        struct('Nr',Nr),...
                  '',  {struct('costMeas','W2ij','lambda',0,'maxiter',100),struct()},...
                  test,         struct('Nh',Nh,'gamma',gamma','beta',beta,'d',d,'rngSeed',rngSeed));
...
exp8 = Experiment('',           {},...
                  'IFKLDMRA',       struct('Nr',Nr,'costMeas','H2ij'),...
                  'ERCTDRef',  {struct('costMeas','FKLDij','lambda',0),struct()},...
                  test,         struct('Nh',Nh,'gamma',gamma','beta',beta,'d',d,'rngSeed',rngSeed));
...
close all
globalMeas = {struct('globMeas','CTD','costMeas','H2ij'),...
              struct('globMeas','CTD','costMeas','BDij'),...
              struct('globMeas','CTD','costMeas','CSDij'),...
              struct('globMeas','FKLD123','nPoints',250),...
