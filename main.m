...
exp2 = Experiment('',           {},...
                  'alpha1Reduction',       struct('Nr',Nr,'alpha',0.5,'maxiter',50,'tol',1e-6),... 
                  '',           {struct('lambda',0.0,'costMeas','KLDij')},...
                  test,         struct('Nh',Nh,'alpha',alpha,'beta',beta,'d',d,'rngSeed',rngSeed));

exp3 = Experiment('',           {},...
                  'alpha2Reduction',        struct('Nr',Nr,'alpha',0.3,'maxiter',50,'tol',1e-6),...
...
globalMeas = {struct('globMeas','CTD','costMeas','KLDij'),...
              ...
              struct('globMeas','CTD','costMeas','alpha2Dij','alpha',0.5),...
