...
gm2 = NISEBarycenter(gm);
gm3 = TSLBarycenter(gm);
gm4 = CSDBarycenter(gm);
...
grid minor
title('Barycenter Comparison')
%axis([-2 5 0 1.5])
legend('Original Mixture','ISE Barycenter','NISE Barycenter','TSL Barycenter','CSD Barycenter','KLD Barycenter','FontSize',34)
...
res4 = strcat('\mu_{CSD}:',' ',num2str(gm4.mu,'%1.4f'),', \Sigma_{CSD}:',' ',num2str(gm4.Sigma,'%1.4f'));
res5 = strcat('\mu_{KLD}:',' ',num2str(gm5.mu,'%1.4f'),', \Sigma_{KLD}:',' ',num2str(gm5.Sigma,'%1.4f'));
