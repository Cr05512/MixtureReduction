...
for i=1:numExperiments
    ...
    if ~isempty(experiments(i).getAlgo) && ~isempty(experiments(i).getTest)
        ...
        disp(strcat(['Experiment: ',num2str(i),' ISE: ',num2str(ISE(gm_vector{i},gmr_vector{i})),', JR2: ',num2str(JR2Divergence(gm_vector{i},gmr_vector{i})),', UTKLD: ',num2str(UTKLD(gm_vector{i},gmr_vector{i})),', Time: ',num2str(time_vector(i)),'s']));
