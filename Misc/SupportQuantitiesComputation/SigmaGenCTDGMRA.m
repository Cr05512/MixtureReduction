...
% INPUTS:
% - lambda1, lambda2, eigenvalues for the the component covariance (scalars),
% - theta, rotation angle for the component covariance (scalar).
% OUTPUTS:
% - Sigma, the newly generated covariance matrix (2 x 2 matrix).
