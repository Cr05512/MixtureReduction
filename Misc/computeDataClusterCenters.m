...
% INPUTS:
% - samples, sample points (stateDim x numSamples matrix),
% - Rnk, association/membership matrix (numSamples x Nr binary matrix).
% OUTPUTS:
% - centers, a matrix whose colums are the cluster centers (stateDim x Nr matrix).
