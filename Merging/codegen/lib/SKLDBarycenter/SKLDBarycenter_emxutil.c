...
{
  emxInit_real_T(&pStruct->mu, 1);
  emxInit_real_T(&pStruct->Sigma, 2);
}
 ...
 * Return Type  : void
 */
void emxInit_struct0_T1(emxArray_struct0_T **pEmxArray, int numDimensions)
{
...
/*
 * File trailer for SKLDBarycenter_emxutil.c
 *
 * [EOF]
 */
