 ...
 *
 * _coder_alphaJDBarycenter_api.c
 *
 * Code generation for function '_coder_alphaJDBarycenter_api'
 *
 */
...
static emlrtRTEInfo yf_emlrtRTEI = {
    1,                              /* lineNo */
    1,                              /* colNo */
    "_coder_alphaJDBarycenter_api", /* fName */
    ""                              /* pName */
};
...
static real_T h_emlrt_marshallIn(const emlrtStack *sp, const mxArray *alpha,
                                 ...
                                 const char_T *identifier)
{
  ...
  thisId.fParent = NULL;
  thisId.bParentIsCell = false;
  y = e_emlrt_marshallIn(sp, emlrtAlias(alpha), &thisId);
...
void alphaJDBarycenter_api(const mxArray *const prhs[4], const mxArray **plhs)
{
  emlrtStack st = {
      NULL, /* site */
      NULL, /* tls */
  ...
  emxInit_struct0_T(&st, &comps, 1, &yf_emlrtRTEI, true);
  emxInitStruct_struct0_T(&st, &bar, &yf_emlrtRTEI, true);
  /* Marshall function inputs */
  c_emlrt_marshallIn(&st, emlrtAliasP(prhs[0]), "comps", comps);
  alpha = h_emlrt_marshallIn(&st, emlrtAliasP(prhs[1]), "alpha");
  maxiter = h_emlrt_marshallIn(&st, emlrtAliasP(prhs[2]), "maxiter");
  tol = h_emlrt_marshallIn(&st, emlrtAliasP(prhs[3]), "tol");
  /* Invoke the target function */
  alphaJDBarycenter(&st, comps, alpha, maxiter, tol, &bar);
...
/* End of code generation (_coder_alphaJDBarycenter_api.c) */
