                      ...
                      emxArray_real_T *B, int32_T rankA, emxArray_real_T *Y)
{
  ...
  Y->size[0] = A->size[1];
  Y->size[1] = B->size[1];
  emxEnsureCapacity_real_T(sp, Y, mn, &gd_emlrtRTEI);
  ...
  if ((A->size[0] != 0) && (A->size[1] != 0) &&
    ...
    if (p) {
      if ((info == -10) && (B->size[1] > 1)) {
        ...
        B->size[0] = info;
        B->size[1] = b_nb;
        emxEnsureCapacity_real_T(&b_st, B, mn, &hd_emlrtRTEI);
        info *= b_nb;
        for (mn = 0; mn < info; mn++) {
          B->data[mn] = rtNaN;
        }
                        ...
                        int32_T rankA, emxArray_creal_T *Y)
{
  ...
  Y->size[0] = A->size[1];
  Y->size[1] = B->size[1];
  emxEnsureCapacity_creal_T(sp, Y, mn, &gd_emlrtRTEI);
  info = A->size[1] * B->size[1];
  for (mn = 0; mn < info; mn++) {
    Y->data[mn].re = 0.0;
    Y->data[mn].im = 0.0;
  }
  emxInit_creal_T(sp, &CB, 2, &rf_emlrtRTEI, true);
  mn = CB->size[0] * CB->size[1];
  CB->size[0] = B->size[0];
  CB->size[1] = B->size[1];
  emxEnsureCapacity_creal_T(sp, CB, mn, &rf_emlrtRTEI);
  ...
  if ((A->size[0] != 0) && (A->size[1] != 0) &&
    ...
    if (p) {
      if ((info == -10) && (CB->size[1] > 1)) {
        ...
        CB->size[0] = info;
        CB->size[1] = b_nb;
        emxEnsureCapacity_creal_T(&b_st, CB, mn, &sf_emlrtRTEI);
        info *= b_nb;
        for (mn = 0; mn < info; mn++) {
          CB->data[mn].re = rtNaN;
          CB->data[mn].im = 0.0;
               ...
               const emxArray_real_T *B, emxArray_creal_T *Y)
{
  ...
  d_st.tls = c_st.tls;
  emlrtHeapReferenceStackEnterFcnR2012b((emlrtCTX)sp);
  emxInit_creal_T(sp, &b_A, 2, &fd_emlrtRTEI, true);
  st.site = &hc_emlrtRSI;
  i = b_A->size[0] * b_A->size[1];
  b_A->size[0] = A->size[0];
  b_A->size[1] = A->size[1];
  emxEnsureCapacity_creal_T(&st, b_A, i, &yc_emlrtRTEI);
  maxmn = A->size[0] * A->size[1];
  for (i = 0; i < maxmn; i++) {
    b_A->data[i] = A->data[i];
  }
  emxInit_int32_T(&st, &jpvt, 2, &fd_emlrtRTEI, true);
  minmn = b_A->size[0];
  na = b_A->size[1];
  i = jpvt->size[0] * jpvt->size[1];
  jpvt->size[0] = 1;
  jpvt->size[1] = b_A->size[1];
  emxEnsureCapacity_int32_T(&st, jpvt, i, &ad_emlrtRTEI);
  maxmn = b_A->size[1];
  for (i = 0; i < maxmn; i++) {
    jpvt->data[i] = 0;
  }
  emxInit_creal_T(&st, &tau, 1, &fd_emlrtRTEI, true);
  ...
  i = tau->size[0];
  tau->size[0] = b_na;
  emxEnsureCapacity_creal_T(&b_st, tau, i, &bd_emlrtRTEI);
  if ((b_A->size[0] == 0) || (b_A->size[1] == 0)) {
    i = tau->size[0];
    tau->size[0] = b_na;
    emxEnsureCapacity_creal_T(&b_st, tau, i, &dd_emlrtRTEI);
    for (i = 0; i < b_na; i++) {
      tau->data[i].re = 0.0;
      tau->data[i].im = 0.0;
    }
    ...
    emxInit_ptrdiff_t(&b_st, &jpvt_t, 1, &cd_emlrtRTEI, true);
    i = jpvt_t->size[0];
    jpvt_t->size[0] = b_A->size[1];
    emxEnsureCapacity_ptrdiff_t(&b_st, jpvt_t, i, &cd_emlrtRTEI);
    maxmn = b_A->size[1];
    for (i = 0; i < maxmn; i++) {
  ...
  if (b_na < minmn) {
    ...
    emlrt_marshallIn(&c_st, b_sprintf(&c_st, y, b_y, &f_emlrtMCI),
             ...
             const emxArray_real_T *B, emxArray_real_T *Y)
{
  ...
  d_st.tls = c_st.tls;
  emlrtHeapReferenceStackEnterFcnR2012b((emlrtCTX)sp);
  emxInit_real_T(sp, &b_A, 2, &fd_emlrtRTEI, true);
  st.site = &hc_emlrtRSI;
  i = b_A->size[0] * b_A->size[1];
  b_A->size[0] = A->size[0];
  b_A->size[1] = A->size[1];
  ...
  emxInit_real_T(&st, &tau, 1, &fd_emlrtRTEI, true);
  b_st.site = &kc_emlrtRSI;
  ma = b_A->size[0];
  na = b_A->size[1];
  ...
  i = tau->size[0];
  tau->size[0] = minmana;
  emxEnsureCapacity_real_T(&b_st, tau, i, &bd_emlrtRTEI);
  if ((b_A->size[0] == 0) || (b_A->size[1] == 0)) {
    i = tau->size[0];
    tau->size[0] = minmana;
    emxEnsureCapacity_real_T(&b_st, tau, i, &dd_emlrtRTEI);
    for (i = 0; i < minmana; i++) {
      tau->data[i] = 0.0;
    }
    c_st.site = &lc_emlrtRSI;
  ...
  emxInit_real_T(&st, &b_B, 2, &ed_emlrtRTEI, true);
  i = b_B->size[0] * b_B->size[1];
  b_B->size[0] = B->size[0];
  b_B->size[1] = B->size[1];
  emxEnsureCapacity_real_T(sp, b_B, i, &ed_emlrtRTEI);
