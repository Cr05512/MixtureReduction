 ...
 *
 * _coder_H2Barycenter_api.c
 *
 * Code generation for function '_coder_H2Barycenter_api'
 *
 */
...
void H2Barycenter_api(const mxArray *const prhs[3], const mxArray **plhs)
{
  emlrtStack st = {
      NULL, /* site */
      NULL, /* tls */
  ...
  emxInit_struct0_T(&st, &comps, 1, &pc_emlrtRTEI, true);
  emxInitStruct_struct0_T(&st, &bar, &pc_emlrtRTEI, true);
  ...
  H2Barycenter(&st, comps, maxiter, tol, &bar);
...
/* End of code generation (_coder_H2Barycenter_api.c) */
