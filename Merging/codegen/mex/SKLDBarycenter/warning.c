...
static emlrtMCInfo e_emlrtMCI = {
    ...
    25,        /* colNo */
    "warning", /* fName */
    "/home/cr055/MATLAB/toolbox/shared/coder/coder/lib/+coder/+internal/"
    "warning.m" /* pName */
};
               ...
               const char_T varargin_2[14])
{
  ...
  *(int32_T *)emlrtMxGetData(m) = varargin_1;
  ...
  emlrtAssign(&e_y, m);
  st.site = &xf_emlrtRSI;
  b_feval(&st, y, c_feval(&st, b_y, c_y, d_y, e_y, &e_emlrtMCI), &f_emlrtMCI);
}
...
void d_warning(const emlrtStack *sp)
{
  ...
  static const char_T msgID[27] = {'M', 'A', 'T', 'L', 'A', 'B', ':', 's', 'q',
                                   'r', 't', 'm', ':', 'S', 'i', 'n', 'g', 'u',
                                   'l', 'a', 'r', 'M', 'a', 't', 'r', 'i', 'x'};
  static const char_T b_u[7] = {'m', 'e', 's', 's', 'a', 'g', 'e'};
  static const char_T u[7] = {'w', 'a', 'r', 'n', 'i', 'n', 'g'};
  ...
  c_y = NULL;
  m = emlrtCreateCharArray(2, &iv2[0]);
  emlrtInitCharArrayR2013a((emlrtCTX)sp, 27, m, &msgID[0]);
  emlrtAssign(&c_y, m);
  st.site = &xf_emlrtRSI;
  b_feval(&st, y, feval(&st, b_y, c_y, &e_emlrtMCI), &f_emlrtMCI);
}
...
void e_warning(const emlrtStack *sp)
{
  ...
  static const char_T msgID[35] = {'C', 'o', 'd', 'e', 'r', ':', 't', 'o', 'o',
                                   'l', 'b', 'o', 'x', ':', 's', 'q', 'r', 't',
                                   'm', '_', 'r', 'o', 'o', 't', 'E', 'i', 'g',
                                   'e', 'n', 'C', 'a', 'n', 'c', 'e', 'l'};
  static const char_T b_u[7] = {'m', 'e', 's', 's', 'a', 'g', 'e'};
