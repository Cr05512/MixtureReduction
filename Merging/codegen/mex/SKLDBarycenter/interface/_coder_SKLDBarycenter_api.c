 ...
 *
 * _coder_SKLDBarycenter_api.c
 *
 * Code generation for function '_coder_SKLDBarycenter_api'
 *
 */
...
static emlrtRTEInfo je_emlrtRTEI = {
    1,                           /* lineNo */
    1,                           /* colNo */
    "_coder_SKLDBarycenter_api", /* fName */
    ""                           /* pName */
};
...
void SKLDBarycenter_api(const mxArray *const prhs[3], const mxArray **plhs)
{
  ...
  emxInit_struct0_T(&st, &comps, 1, &je_emlrtRTEI, true);
  emxInitStruct_struct0_T(&st, &bar, &je_emlrtRTEI, true);
  ...
  SKLDBarycenter(&st, comps, maxiter, tol, &bar);
  /* Marshall function outputs */
  *plhs = b_emlrt_marshallOut(bar);
  emxFreeStruct_struct0_T(&bar);
  emxFree_struct0_T(&comps);
  emlrtHeapReferenceStackLeaveFcnR2012b(&st);
}

/* End of code generation (_coder_SKLDBarycenter_api.c) */
