                       ...
                       emxArray_real_T *Sigma)
{
  ...
  i = w->size[0];
  w->size[0] = gm->size[0];
  emxEnsureCapacity_real_T(sp, w, i, &bc_emlrtRTEI);
  i = mu->size[0] * mu->size[1];
  mu->size[0] = gm->data[0].mu->size[0];
  mu->size[1] = gm->size[0];
  emxEnsureCapacity_real_T(sp, mu, i, &cc_emlrtRTEI);
  ...
  emxEnsureCapacity_real_T(sp, Sigma, i, &dc_emlrtRTEI);
  i = gm->size[0];
  for (b_i = 0; b_i < i; b_i++) {
    if (b_i + 1 > gm->size[0]) {
      emlrtDynamicBoundsCheckR2012b(b_i + 1, 1, gm->size[0], &t_emlrtBCI,
                                    (emlrtCTX)sp);
    }
    if (b_i + 1 > w->size[0]) {
      emlrtDynamicBoundsCheckR2012b(b_i + 1, 1, w->size[0], &u_emlrtBCI,
                                    (emlrtCTX)sp);
    }
    w->data[b_i] = gm->data[b_i].w;
    if (b_i + 1 > mu->size[1]) {
      emlrtDynamicBoundsCheckR2012b(b_i + 1, 1, mu->size[1], &r_emlrtBCI,
                                    (emlrtCTX)sp);
    }
    if (b_i + 1 > gm->size[0]) {
      emlrtDynamicBoundsCheckR2012b(b_i + 1, 1, gm->size[0], &p_emlrtBCI,
                                    (emlrtCTX)sp);
    }
    ...
    if (b_i + 1 > gm->size[0]) {
      emlrtDynamicBoundsCheckR2012b(b_i + 1, 1, gm->size[0], &q_emlrtBCI,
                                    (emlrtCTX)sp);
    }
