function NSKLD = SKLD123(gmh,gmr,nPoints)
% NSKLD = SKLD12(gmh,gmr,nPoints):
% INPUT:
...
if d==1
    ...
    f = (sOrig-sRed).*log(sOrig) - (sOrig-sRed).*log(sRed);
    f(isnan(f)) = 0;
...
elseif d==3
    ...
    NSKLD = trapz(x3,trapz(x2,trapz(x1,f,3),2));
