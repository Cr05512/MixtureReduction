...
for i=1:length(alpha)
    DaVal(i) = alpha2Dij(g1,g2,alpha(i));
end
...
% txt1 = '\leftarrow D_{RKL}';
% txt2 = '\leftarrow D_{FKL}';
% text(0,DaVal(1),txt1,'FontSize',24); hold on
% text(1,DaVal(end),txt2,'FontSize',24); hold on
% scatter(0,DaVal(1),100,'m*','LineWidth',4);
% scatter(1,DaVal(end),100,'r*','LineWidth',4);
[maxVal,maxIdx] = max(DaVal);
