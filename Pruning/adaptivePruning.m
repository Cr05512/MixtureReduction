function gmr = adaptivePruning(gmh,rho)
% gmr = adaptivePruning(gm, rho):
% INPUTS:
% - gm, a Gaussian Mixture,
% - rho, percentile threshold (scalar).
% OUTPUTS:
...
%disp(strcat(num2str(length(gmh)-length(gmr)),' components have been pruned.'));
w = num2cell(w_bar);
[gmr.w] = w{:};
