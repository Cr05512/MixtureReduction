function gmr = CMOptCon(gmr,gmh,NOptSteps,accThresh)
% gmr = CMOptCon(gmr,gmh,NOptSteps,accThresh):
% - gmr, gmh, two Gaussian Mixtures,
% - NOptSteps, maximum number of optimization steps,
% - accThresh, accuracy threshold.
% This function performs the Correlation Measure Optimization on the parameters of the
...
function [f,grad] = funGradComp(x,gmh,Nr)
    ...
    [gfw,gfmu,gfL] = gradCM(w,mu,L,wh,muh,Sigmah);
